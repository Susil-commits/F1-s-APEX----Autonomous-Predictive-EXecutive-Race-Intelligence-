...
# Install system runtime dependencies (libgomp1 for PyTorch/XGBoost OpenMP, curl for healthchecks)
...
# Copy compiled frontend from Stage 1 into FastAPI's static mount directory
