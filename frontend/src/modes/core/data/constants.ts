...
export const DRIVERS_LIST: DriverItem[] = [
  { code: 'VER', firstName: 'Max', lastName: 'VERSTAPPEN', team: 'Red Bull Racing', number: 1, color: '#3671C6', country: '🇳🇱', defaultGrid: 1, photo: '/f1/drivers/VER.webp' },
  { code: 'NOR', firstName: 'Lando', lastName: 'NORRIS', team: 'McLaren', number: 4, color: '#FF8000', country: '🇬🇧', defaultGrid: 2, photo: '/f1/drivers/NOR.webp' },
  { code: 'LEC', firstName: 'Charles', lastName: 'LECLERC', team: 'Ferrari', number: 16, color: '#E80020', country: '🇲🇨', defaultGrid: 3, photo: '/f1/drivers/LEC.webp' },
  { code: 'PIA', firstName: 'Oscar', lastName: 'PIASTRI', team: 'McLaren', number: 81, color: '#FF8000', country: '🇦🇺', defaultGrid: 4, photo: '/f1/drivers/PIA.webp' },
  { code: 'HAM', firstName: 'Lewis', lastName: 'HAMILTON', team: 'Ferrari', number: 44, color: '#E80020', country: '🇬🇧', defaultGrid: 5, photo: '/f1/drivers/HAM.webp' },
  { code: 'RUS', firstName: 'George', lastName: 'RUSSELL', team: 'Mercedes', number: 63, color: '#00A19B', country: '🇬🇧', defaultGrid: 6, photo: '/f1/drivers/RUS.webp' },
  { code: 'ANT', firstName: 'Kimi', lastName: 'ANTONELLI', team: 'Mercedes', number: 12, color: '#00A19B', country: '🇮🇹', defaultGrid: 7, photo: '/f1/drivers/ANT.webp' },
  { code: 'SAI', firstName: 'Carlos', lastName: 'SAINZ', team: 'Williams', number: 55, color: '#64C4FF', country: '🇪🇸', defaultGrid: 8, photo: '/f1/drivers/SAI.webp' },
  { code: 'PER', firstName: 'Sergio', lastName: 'PEREZ', team: 'Red Bull Racing', number: 11, color: '#3671C6', country: '🇲🇽', defaultGrid: 8, photo: '/f1/drivers/PER.webp' },
  { code: 'ALO', firstName: 'Fernando', lastName: 'ALONSO', team: 'Aston Martin', number: 14, color: '#229971', country: '🇪🇸', defaultGrid: 9, photo: '/f1/drivers/ALO.webp' },
  { code: 'STR', firstName: 'Lance', lastName: 'STROLL', team: 'Aston Martin', number: 18, color: '#229971', country: '🇨🇦', defaultGrid: 10, photo: '/f1/drivers/STR.webp' },
  { code: 'TSU', firstName: 'Yuki', lastName: 'TSUNODA', team: 'RB', number: 22, color: '#6692FF', country: '🇯🇵', defaultGrid: 11, photo: '/f1/drivers/TSU.webp' },
  { code: 'ALB', firstName: 'Alexander', lastName: 'ALBON', team: 'Williams', number: 23, color: '#64C4FF', country: '🇹🇭', defaultGrid: 12, photo: '/f1/drivers/ALB.webp' },
  { code: 'HUL', firstName: 'Nico', lastName: 'HULKENBERG', team: 'Kick Sauber', number: 27, color: '#52E252', country: '🇩🇪', defaultGrid: 13, photo: '/f1/drivers/HUL.webp' },
  { code: 'RIC', firstName: 'Daniel', lastName: 'RICCIARDO', team: 'RB', number: 3, color: '#6692FF', country: '🇦🇺', defaultGrid: 14, photo: '/f1/drivers/RIC.webp' },
  { code: 'GAS', firstName: 'Pierre', lastName: 'GASLY', team: 'Alpine', number: 10, color: '#0093CC', country: '🇫🇷', defaultGrid: 15, photo: '/f1/drivers/GAS.webp' },
  { code: 'OCO', firstName: 'Esteban', lastName: 'OCON', team: 'Alpine', number: 31, color: '#0093CC', country: '🇫🇷', defaultGrid: 16, photo: '/f1/drivers/OCO.webp' },
  { code: 'MAG', firstName: 'Kevin', lastName: 'MAGNUSSEN', team: 'Haas', number: 20, color: '#B6BABD', country: '🇩🇰', defaultGrid: 17, photo: '/f1/drivers/MAG.webp' },
  { code: 'ZHO', firstName: 'Guanyu', lastName: 'ZHOU', team: 'Kick Sauber', number: 24, color: '#52E252', country: '🇨🇳', defaultGrid: 18, photo: '/f1/drivers/ZHO.webp' },
  { code: 'BOT', firstName: 'Valtteri', lastName: 'BOTTAS', team: 'Kick Sauber', number: 77, color: '#52E252', country: '🇫🇮', defaultGrid: 19, photo: '/f1/drivers/BOT.webp' },
  { code: 'SAR', firstName: 'Logan', lastName: 'SARGEANT', team: 'Williams', number: 2, color: '#64C4FF', country: '🇺🇸', defaultGrid: 20, photo: '/f1/drivers/SAR.webp' },
  { code: 'BEA', firstName: 'Oliver', lastName: 'BEARMAN', team: 'Haas', number: 87, color: '#B6BABD', country: '🇬🇧', defaultGrid: 14, photo: '/f1/drivers/BEA.webp' },
  { code: 'LAW', firstName: 'Liam', lastName: 'LAWSON', team: 'RB', number: 30, color: '#6692FF', country: '🇳🇿', defaultGrid: 12, photo: '/f1/drivers/LAW.webp' },
  { code: 'COL', firstName: 'Franco', lastName: 'COLAPINTO', team: 'Williams', number: 43, color: '#64C4FF', country: '🇦🇷', defaultGrid: 13, photo: '/f1/drivers/COL.webp' },
];
